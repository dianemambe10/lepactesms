        ...
        <div class="card-body">
                ...
                <table v-if="items.length!==0" class="table table-hover table-bordered">
                    ...
                    <tr  v-for="(index , item) in items" >
                        ...
                        <td>@{{ item.phone  }}</td>
                        <td>
                            <a class="btn btn-outline-info btn-sm"  href="#"  v-on:click="fshowmodal(item.id)">Show</a>


                            <a  class="btn btn-outline-danger btn-sm" href="#"   v-on:click="deleteCandidat(item.id ,  index )">Delete
                            </a>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header bg-blue" >
                            <h4 class="modal-title" id="myModalLabel">CARL </h4>
                    ...
                    ddddddddddd
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" @click="fermer()">FERMER</button>
                            <button type="button" @click="saveAffectation()" class="btn btn-primary">ENREGISTRER</button>
                        </div>
                    </div>
                </div>
